...
function HeaderCards() {
    const displayingCard = (e) => {
        const cards = e.currentTarget.parentElement.parentElement.parentElement.parentElement.childNodes
        cards.forEach((card) => {
            let initialCard = card.firstChild.firstChild.firstChild;
            initialCard.classList.add( 'translate-x-36','max-lg:translate-x-40', 'max-xl:translate-x-28' ,'max-md:translate-x-[230px]', "max-sm:translate-x-36", 'transition-all', 'duration-1000')
            let content = initialCard.parentElement.nextElementSibling;
    ...
    return (
        <div className='container max-w-7xl mx-auto text-center max-xl:!max-w-5xl max-lg:!max-w-4xl max-md:!max-w-xl max-sm:!max-w-sm'>
            <div className='text-xl mb-16 text-white'>
                ...
                <div className='w-3/4 mx-auto max-sm:w-full'>
                    <p className="max-sm:text-left max-sm:text-base">To learn about the Services we are providing hope on to our Card section and choose whatever seems best for you</p>
                    <p className="max-sm:text-left max-sm:text-base">Here we have 3 different categories distributed as HTML CSS and JAVASCRIPT</p>
                    <p className="max-sm:text-left max-sm:text-base">Please choose from the card below which you want to Practice or Learn about</p>
                </div>
            </div>
            <div className='grid grid-cols-3 gap-14 text-white max-xl:gap-10 max-lg:grid-cols-2 max-md:grid-cols-1'>
                <div className='w-full h-full bg-transparent flex justify-center items-center max-md:col-span-2'>
                    <div className='flex flex-col h-[98%] w-[98%]'>
                        ...
                        <div className="hidden">
                            <div className='relative text-2xl text-left -translate-y-24 mx-5 opacity-0 -z-[1]'>
                                <h2 className='max-lg:text-2xl'>HTML - Hyper Text Mark-up Language</h2>
                            </div>
                            <div className='relative text-2xl text-left mx-5 -translate-y-24 opacity-0 -z-[1] flex-grow'>
                    ...
                    <div className='flex flex-col h-[98%] w-[98%]'>
                        ...
                        <div className='hidden'>
                            <div className='relative text-2xl text-left mx-5 -translate-y-24 opacity-0 -z-[1]'>
                                <h2 className='max-lg:text-2xl'>CSS - Cascading Style Sheet</h2>
                            </div>
                            <div className='relative text-2xl text-left mx-5 -translate-y-24 opacity-0 -z-[1] '>
                                <h2 className='font-bold my-3'>Description</h2>
                ...
                <div className='w-full h-full bg-transparent flex justify-center items-center max-lg:col-span-2 max-lg:justify-self-center max-lg:w-[48%] max-md:w-full'>
                    <div className='flex flex-col h-[98%] w-[98%]'>
                        <div className='my-5 flex justify-start mx-5'>
                        ...
                        <div className='hidden'>
                            <div className='relative text-2xl text-left mx-5 -translate-y-24 opacity-0 -z-[1]'>
                                <h2 className='max-lg:text-2xl'>JS - Java Script</h2>
                            </div>
                            <div className='relative text-2xl text-left mx-5 -translate-y-24 opacity-0 -z-[1]'>
                                <h2 className='font-bold my-3'>Description</h2>
