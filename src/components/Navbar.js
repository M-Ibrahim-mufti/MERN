        ...
        <div id="navbar" className={`fixed w-screen h-14 text-white z-30 ${colorizeNav ? 'bg-nav': ''}`}>
            <div className="container h-full max-w-5xl mx-auto text-center flex items-center">
                ...
                <ul className="hidden w-1/2 flex justify-between">
                    ...
                    <li className="opacity-0 -translate-y-14 flex items-center"><button className="cursor-pointer text-[#9b9b9b] hover:text-white transition-all duration-500 ease-linear" onClick={prop.destroySession}> Sign Out</button></li>
                </ul>
