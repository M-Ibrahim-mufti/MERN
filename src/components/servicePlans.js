            ...
            <div className="grid grid-cols-3 gap-14"> 
                <div id='planCard1' className="cursor-pointer w-full h-full bg-[rgb(17,58,89,0.5)] rounded-lg border-2 border-white scale-90 plan-head">
                    ...
                    <div className="w-4/5 text-center mx-auto text-white mb-5">
                        <button disabled className="z-10 w-16 hover:w-1/2 hover:bg-white hover:text-[rgb(17,58,89)] hover:font-extrabold hover:text-xl hover:h-10 hover:rounded-xl transition-all duration-500 ease-linear" >Buy Now</button>
                    </div>
                </div>
                <div id='planCard2' className="cursor-pointer w-full h-full bg-[rgb(17,58,89,0.5)] rounded-lg border-2 border-white plan-head">
                    <div className="text-white text-center text-3xl py-4">
                ...
                <div id='planCard3' className="cursor-pointer w-full h-full bg-[rgb(17,58,89,0.5)] rounded-lg border-2 border-white scale-90 plan-head">
                    <div className="text-white text-center text-3xl py-4">
