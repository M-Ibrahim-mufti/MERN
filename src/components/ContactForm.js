            ...
            <div className="my-14">
                <div className="flex w-11/12 mx-auto my-5 gap-8">
                    <div className="w-1/2 relative">
                        ...
                        <input onChange={handleFirstNameChange}  className="rounded-lg input-field border-2 border-[rgba(255,255,255,0.6)] w-full my-2 h-12 text-xl bg-transparent px-3 outline-none" type="text"/>
                    </div>
                    <div className="w-1/2 relative">
                        <label className="input-label">Last Name</label>
                        <input onChange={handleLastNameChange} className="rounded-lg input-field border-2 border-[rgba(255,255,255,0.6)] w-full my-2 h-12 text-xl bg-transparent px-3 outline-none" type="text"/>
                    </div>
                </div>
                <div data-text="Email" className="flex relative w-11/12 mx-auto my-5">
                    <label className="input-label">Email</label>
                    <input onChange={handleEmailChange} className="rounded-lg input-field border-2 border-[rgba(255,255,255,0.6)] w-full my-2 h-12 text-xl bg-transparent px-3  outline-none" type="email"/>
                </div>
                <div className="flex relative w-11/12 mx-auto my-5 ">
                    <label className="input-label !top-[10px] left-[3px]">Having Trouble feel free to contact us with your issue</label>
                    <textarea onChange={handleMessageChange} className="rounded-lg w-full border-2 border-[rgba(255,255,255,0.5)] text-xl bg-transparent py-2 px-3 outline-none max-h-60"/>
                </div>
