...
function AboutCircle () {
    ...
    const revealAbout = (event) => {
        ...
        setTimeout(() => {
            ...
            event.target.classList.add('bottom-[440px]', 'left-[590px]', 'opacity-1')
